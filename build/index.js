...
var MioxKoaVue2xServerRender = function () {
    ...
    (0, _createClass3.default)(MioxKoaVue2xServerRender, [{
        ...
        value: function RUN_IN_PRODUCTION() {
            var PATH_BUILD_PREFIX = _path2.default.resolve(process.cwd(), this.options.buildPrefix);
            var PATH_SSR_BUNDLE = _path2.default.resolve(PATH_BUILD_PREFIX, 'vue-ssr-bundle.json');
            var PATH_SSR_TEMPLATE = _path2.default.resolve(PATH_BUILD_PREFIX, 'index.html');
        ...
        value: function SETUP_DEV_SERVER(cb) {
            ...
            clientCompiler.plugin('done', function () {
                ...
                var filePath = _path2.default.join(_this6.clientConfig.output.path, 'index.html');
            ...
            serverCompiler.watch({}, function (err, stats) {
                ...
                var bundlePath = _path2.default.join(_this6.serverConfig.output.path, 'vue-ssr-bundle.json');
